...
| 10 | Performance Validation & Load Testing | Leitura e escrita testadas contra staging real (smoke + baseline), sem nenhum gargalo encontrado; fluxos de Smart Home/push e comparação formal com metas pendentes | **6/7 — parcial** |
