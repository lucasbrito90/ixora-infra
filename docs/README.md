...
| 3 | **Observability Foundation** | **Phase 7A, 7B.1–7B.4.9 + 8.0–8.5 complete — Backend SDK Foundation + HTTP/Routing + Queue/Console + generic Scheduler (`back_vibes`); Smart Home Business Telemetry full cycle (domain review, dispatch/action/provider spans, failure semantics, metrics, logging, validation, foundation baseline); Grafana dashboards: D-07 Infrastructure (21 panels), D-04 Queue Workers (17 panels), D-05 HTTP API (15 panels), D-06 Scheduler (17 panels), D-02 Smart Home Business (23 panels), **D-01 Platform Overview** (32 panels); 42/42 validation checks pass; dashboard-conventions.md established** | [backend-sdk-foundation](specs/observability-foundation/mvp/backend-sdk-foundation.md) · [backend-queue-console-instrumentation](specs/observability-foundation/mvp/backend-queue-console-instrumentation.md) · [backend-generic-scheduler-instrumentation](specs/observability-foundation/mvp/backend-generic-scheduler-instrumentation.md) · [domain-execution-review](specs/observability-foundation/business-telemetry/domain-execution-review.md) · [backend-smart-home-dispatch-boundary](specs/observability-foundation/business-telemetry/backend-smart-home-dispatch-boundary.md) · [backend-smart-home-action-execution](specs/observability-foundation/business-telemetry/backend-smart-home-action-execution.md) · [backend-smart-home-provider-boundary](specs/observability-foundation/business-telemetry/backend-smart-home-provider-boundary.md) · [backend-business-failure-semantics](specs/observability-foundation/business-telemetry/backend-business-failure-semantics.md) · [backend-smart-home-business-metrics](specs/observability-foundation/business-telemetry/backend-smart-home-business-metrics.md) · [backend-smart-home-business-logging](specs/observability-foundation/business-telemetry/backend-smart-home-business-logging.md) · [business-telemetry-foundation](specs/observability-foundation/business-telemetry/business-telemetry-foundation.md) · [dashboard-requirements](specs/observability-foundation/mvp/dashboard-requirements.md) · [dashboard-conventions](specs/observability-foundation/mvp/dashboard-conventions.md) · [grafana-foundation](specs/observability-foundation/mvp/grafana-foundation.md) · [dashboard-d07-infrastructure](specs/observability-foundation/mvp/dashboard-d07-infrastructure.md) · [dashboard-d04-queue](specs/observability-foundation/mvp/dashboard-d04-queue.md) · [dashboard-d05-http](specs/observability-foundation/mvp/dashboard-d05-http.md) · [dashboard-d06-scheduler](specs/observability-foundation/mvp/dashboard-d06-scheduler.md) · [dashboard-d02-smart-home](specs/observability-foundation/mvp/dashboard-d02-smart-home.md) · [dashboard-d01-platform-overview](specs/observability-foundation/mvp/dashboard-d01-platform-overview.md) · [traces-philosophy](architecture/traces-philosophy.md) · [metrics-philosophy](architecture/metrics-philosophy.md) |
