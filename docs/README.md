...
*Last indexed: documentation tree under `ixora-infra/docs/`. Last updated: 2026-07-19 (observability-foundation Phase 8.6 — Dashboard Integration & Operational Validation).*
